...
export function Welcome({ savedDashboards }: Props) {
  ...
  return (
    <main className="h-full bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950 overflow-y-auto">
      <div className="flex flex-col items-center px-6 py-12 space-y-12 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
              {savedDashboards.map((d) => (
                <Link
                  ...
                  className="flex items-center gap-3 rounded-xl border bg-white dark:bg-gray-900 px-4 py-3 shadow-sm hover:shadow-md hover:border-primary/40 transition-all"
                >
